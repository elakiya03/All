...
//@Data //shortcut annotation 
//@AllArgsConstructor //generated constructor with 1 parameter for each field
...
//		Stream.of("Lining","PUMA","Bad Boy","Air Jordan","Nike").forEach(item -> itemRepository.save(new Item(item)));
//	
